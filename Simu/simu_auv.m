function [ground_truth, measurements, views] = simu_auv(init_state_vector, waypoints, depth, dt)
    ...
    while true && iter < 500000
        ...
        if (mod(iter,100) == 0)
            view = sensor_data(state_vector, window, depth);
            views = [views; view];
        end
